...
namespace Watermelon
{
    public static class CoreExtensions
    {
        ...
        /// <summary>
        /// Add event trigger to panel and subscript listener
        /// </summary>
        public static void AddEventToPanel(this GameObject gameObject, UnityAction<BaseEventData> call, EventTriggerType eventTriggerType = EventTriggerType.PointerClick)
        {
            EventTrigger eventTrigger = gameObject.GetOrSetComponent<EventTrigger>();
