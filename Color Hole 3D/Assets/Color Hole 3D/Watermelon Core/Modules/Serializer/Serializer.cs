...
namespace Watermelon
{
    ...
    public static class Serializer
    {
        ...
        public static void BinarySeserializeToResourses<T>(T objectToSerialize, string fileName)
        {
            ...
            BinaryFormatter bf = new BinaryFormatter();
            FileStream file = File.Open(Application.dataPath + ApplicationConsts.PROJECT_FOLDER + "/Resources/" + fileName, FileMode.Create);
        ...
        {
            File.Delete(Application.dataPath + ApplicationConsts.PROJECT_FOLDER + "/Resources/" + fileName);
        }
